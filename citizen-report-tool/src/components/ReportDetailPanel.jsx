...
export function Answers({ data }) {
  ...
  const rows = [
    ...
    ['Outdoors', data.outdoors == null ? '—' : data.outdoors ? 'Yes' : 'No'],
    ['Felt vibration', data.outdoors ? 'N/A (outdoors)' : data.felt_vibration ? 'Yes' : 'No'],
    ['Windows open', data.outdoors ? 'N/A (outdoors)' : data.windows_open ? 'Yes' : 'No'],
